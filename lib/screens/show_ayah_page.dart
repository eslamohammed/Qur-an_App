...
class _ShowAyahState extends State<ShowAyah> {
  ...
  int getGlobalVerseNumber(int surahNumber, int verseNumber) {
    ...
    int offset =
        versesPerSurah.sublist(0, surahNumber - 1).fold(0, (a, b) => a + b);
            ...
            children: [
                          ...
                          IconButton(
                              onPressed: () async {
                                try {
                                  ...
                                  play(getAudioURLByVerseNumber(
                                      getGlobalVerseNumber(
                                          widget.suraNumber, widget.ayahNumber),
                                      reciter));
                                  if (kDebugMode) {
                                    print(
                                        "${getGlobalVerseNumber(widget.suraNumber, widget.ayahNumber)}");
                                    print(getAudioURLByVerseNumber(
                                        getGlobalVerseNumber(widget.suraNumber,
                                            widget.ayahNumber),
                                        reciter));
                                  }
                                } catch (e) {
                                  showToast("خطأ في التشغيل أو الاتصال",
                                      isError: true);
                                  showToast("Check your Network Connection",
                                      isError: true);
                                  print(
              ...
              Padding(
                ...
                child: EasyContainer(
                  ...
                  onTap: () async {
                    ////here
                    final verse = getVerse(widget.suraNumber, widget.ayahNumber,
                        verseEndSymbol: true);
